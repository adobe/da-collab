...
import { closeConn, showError } from './utils.js';
import { aem2doc, doc2aem, EMPTY_DOC } from './collab.js';
import { MAX_STORAGE_KEYS, MAX_STORAGE_VALUE_SIZE } from './config.js';
 ...
 */
const readState = async (docName, storage) => {
 ...
 */
const storeState = async (docName, state, storage, chunkSize = MAX_STORAGE_VALUE_SIZE) => {
  await storage.deleteAll();
...
export { persistence, readState, storeState };
